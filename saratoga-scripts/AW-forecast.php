...
//  or ------------
//    $doIncludeAW = true;
//    $doPrintConditions = false;
//    $doPrintHeadingAW = false;
//    $doPrintIconsAW = true;
//    $doPrintTextAW = false
...
$AWAPIkey = 'Ok3aWX6hA5NczrIqqEzEz';    // Aeris Access ID; use this only for standalone / non-template use
$AWAPIsecret = 'vVjMvIFvUUGx86dYlz4uCsqtIg4V47tVP8a6Kwf3'; // Aeris Secret Key; use this only for standalone / non-template use 

// NOTE: if using the Saratoga template, add to Settings.php a line with:
//    $SITE['AWAPIkey'] = 'Ok3aWX6hA5NczrIqqEzEz';
//    $SITE['AWAPIsecret'] = 'vVjMvIFvUUGx86dYlz4uCsqtIg4V47tVP8a6Kwf3';
