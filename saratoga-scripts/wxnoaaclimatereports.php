...
//Version 1.02 - 27-Dec-2022 - fixes for PHP 8.2
//Version 1.03 - 17-Feb-2023 - added WD support 
...
<div id="main-copy">
    ...
    <?php if(file_exists('include-NOAA-reports.php')) 
		  {include_once("include-NOAA-reports.php"); }
		  else {print "<p>".langtransstr('NOAA reports are not available.')."</p>\n"; } ?>
