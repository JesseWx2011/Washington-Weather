...
$SITE['WXRstartup'] = 'KHB36';   // override $startup in wxradio.php
...
$SITE['mapboxAPIkey'] = 'pk.eyJ1IjoiaGFzdHl0dWJlIiwiYSI6ImNsa2hkZTh6bzAwazQzZHFyNmF5aTRsZGwifQ.5QJvYIHo0odZ5jCFApV7yw';  // use this for the Access Token (API key) to MapBox


*/
############################################################################
#
$startup = 'KHB36'; // Radio for first display, if 'alternate' include the -[char] in the name
